...
public class PayUSdk extends AppCompatActivity {
...
//                    Toast.makeText(PayUSdk.this, getString(R.string.use_live_key_in_production_environment), Toast.LENGTH_SHORT).show();
//
//                    /* For test keys, please contact mobile.integration@payu.in with your app name and registered email id
//                     */
//                    ((EditText) findViewById(R.id.editTextMerchantKey)).setText("2uICKv");
//                }
//                else{
...
//        mPaymentParams.setPhone("1233121233");
//
//
//        /*
...
//            super.onPreExecute();
//            progressDialog = new ProgressDialog(PayUSdk.this);
...
//                URL url = new URL(Common.PAYU_HASHLINK);
//
