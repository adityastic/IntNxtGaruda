package com.nxtvision.capitalstar.firebasemessaging;
...
import com.nxtvision.capitalstar.activities.SplashScreen;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            if(data.get("type").equals("panel")){
                Common.savePanel(getApplicationContext(), remoteMessage.getData().get("message"));
                sendNotification("Check New Panel Update", "New Panel", "panel");
            }else{
                String type = "";
                try {
