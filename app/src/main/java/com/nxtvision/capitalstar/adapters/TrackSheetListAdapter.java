    ...
    public void onBindViewHolder(@NonNull ServicesHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "/" + context.getResources().getString(R.string.app_name) + "/" + "/Sheets/" + service);
                            ...
                            if (total.equals(downloaded) && downloadComplete) {
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        dialog.dismiss();
                                        sendNotification(
                                                Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/" + context.getResources().getString(R.string.app_name) + "/Sheets/" + service
                                        );
                                    }
                                }, 500);
                            }
