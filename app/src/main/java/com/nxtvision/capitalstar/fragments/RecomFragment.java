...
import com.nxtvision.capitalstar.adapters.RecomAdapter;
...
public class RecomFragment extends Fragment {
    ...
    public void refreshLayout() throws JSONException {
        ...
        Log.e("Recom",Common.sharedPreferences.getString("recom","[]"));
        JSONArray response = new JSONArray(Common.sharedPreferences.getString("recom","[]"));
        ...
        if (morningBellList.size() > 150)
            morningBellList = new ArrayList<>(morningBellList.subList(0, 150));
        ...
        Common.sharedPreferences.edit().putString("recom",arr.toString()).apply();
