...
import com.nxtvision.capitalstar.data.LoginDetails;
import com.nxtvision.capitalstar.data.NewsInfo;
import com.nxtvision.capitalstar.data.Question;
import com.nxtvision.capitalstar.views.OTPEditText;
...
public class Common {
    ...
    private static String IP = "http://192.168.0.66/capitalstar/";
...
//    public static final String CHANNEL_2_ID = "recommendChannel";
    ...
    public static void savePanel(Context context, String data) {
       ...
       sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        ...
        try {
            ...
            JSONArray array = new JSONArray(sharedPreferences.getString("panel", "[]"));
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("file", obj.getString("file"));
            jsonObject.put("info", obj.getString("info"));
            jsonObject.put("link", obj.getString("link"));
            Date d = Calendar.getInstance().getTime();
            String date = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(d);
            ...
            sharedPreferences.edit().putString("panel", array.toString()).apply();
